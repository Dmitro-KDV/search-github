...
const footerModar = document.querySelector('.icon-hear');
...
footerModar.addEventListener('click', footer_Modar);

function footer_Modar(event) {
    event.preventDefault();
    const img= "./images/oops-chef.jpg";
